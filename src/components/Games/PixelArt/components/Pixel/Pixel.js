...
//border exists only if size is 10px
    render(){
        return (
            ...
            onMouseEnter={e => {
                if(e.buttons === 1 && this.props.color !== this.props.pixel.color || e.buttons === 1 && this.props.pixel.opacity !== this.props.opacity){
                    this.props.chooseColor(this.props.color, this.props.opacity, this.props.index, this.props.allArr)
                }
            }}
            onMouseLeave={e => {
                if(e.buttons === 1 && this.props.pixel.color !== this.props.color || e.buttons === 1 && this.props.pixel.opacity !== this.props.opacity){
                    this.props.chooseColor(this.props.color, this.props.opacity, this.props.index, this.props.allArr)
                }
            }}
            >
